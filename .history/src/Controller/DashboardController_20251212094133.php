...
class DashboardController extends AbstractController
{
    ...
    public function index(
        ...
        if ($this->getUser() && method_exists($this->getUser(), 'isStaff') && $this->getUser()->isStaff()) {
            return $this->redirectToRoute('app_home'); // Change 'app_home' to the appropriate route for staff
        }
        // Basic Counts
